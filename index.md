...
작업 내용 : 
 ...
 2. 텍스트로 enter press anykey 게임화면에 띄우기
 2.5. 분할된 상태의 플레이어가 있는 그림의 창을 띄워둠 (게임화면이라 가정)

 3. esc입력 시 화면 중앙에 메뉴 출력(게임나가기, 게임저장)

 4. enter를 누를 시 게임저장 () 방향키를 이용해 아랫방향키를 입력하면 게임나가기가 선택됨.

 5. 게임저장 시 세이브완료라는 텍스트 출력

 6. 게임나가기 선택 후 enter입력 시 게임종료
