...
- 스테이지 클리어시 만족감을 느낄 수 있도록 개발
- 다양한 스테이지와 여러 장애물을 이용하고 피하면서 지루하지 않게 게임을 플레이 하게 부추김 
...
### 서브 컨셉 3 : 엽기
- 생각하지 못한 이미지의 플레이어와 장애물로 이상하다 느낄 수 있지만 재미를 느끼게 하는게 목표
...
- 점수를 먹을 수 있는 오브젝트를 구현해 점수를 얻을 수 있다.
